...
```{r}
which( colnames(join3)=="ctq1_2") #43
join3 <- join3[ -c(43)]

which( colnames(join3)=="ctq1_5") #45
join3 <- join3[ -c(45)]

which( colnames(join3)=="ctq1_7") #46
join3 <- join3[ -c(46)]

which( colnames(join3)=="ctq2_13") #51
join3 <- join3[ -c(51)]

which( colnames(join3)=="ctq3_19") #56
join3 <- join3[ -c(56)]

which( colnames(join3)=="ctq4_26") #62
join3 <- join3[ -c(62)]

which( colnames(join3)=="ctq4_28") #63
join3 <- join3[ -c(63)]

which( colnames(join3)=="ctq_complete") #63
join3 <- join3[ -c(63)]
```
...
#cp_joined2 has 237 observations.
...
#cp_joined has 185 observations and 320 variables.
```
